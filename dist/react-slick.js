...
function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      } else if (this.props.centerMode && newChildren.length < settings.slidesToShow || !this.props.centerMode && newChildren.length <= settings.slidesToShow) {
...
var getTrackCSS = function getTrackCSS(spec) {
  ...
  if (!spec.vertical) {
    trackWidth = spec.centerMode && spec.slideCount >= spec.slidesToShow || spec.slideCount > spec.slidesToShow ? getTotalSlides(spec) * spec.slideWidth : spec.listWidth;
  } else {
...
var renderSlides = function renderSlides(spec) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.forEach(spec.children, function (elem, index) {
    ...
    if (spec.infinite && spec.fade === false && (spec.centerMode && childrenCount >= spec.slidesToShow || !spec.centerMode && childrenCount > spec.slidesToShow)) {
      ...
      if (spec.centerMode && childrenCount >= spec.slidesToShow || !spec.centerMode && childrenCount > spec.slidesToShow) {
